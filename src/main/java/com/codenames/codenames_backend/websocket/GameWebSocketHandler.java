...
public class GameWebSocketHandler extends TextWebSocketHandler {
     ...
     *
     * @param websocketLobbyService the lobby service used for managing players
     */
    public GameWebSocketHandler(WebsocketLobbyService websocketLobbyService) {
        this.websocketLobbyService = websocketLobbyService;
    }
    ...
    private void handleJoin(JsonNode json, WebSocketSession session) throws IOException {
        ...
        websocketLobbyService.addPlayer(code, player);
    ...
    private void broadcastPlayerList(String code) throws IOException {
        ...
        var players = websocketLobbyService.getPlayers(code);
